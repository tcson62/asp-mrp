...
:precondition (and (can_traverse ?x ?y ?z) (available ?x)
                (visible ?y ?z)
      )
...
(:action calibrate
 ...
 :precondition (and (equipped_for_imaging ?r) (calibration_target ?i ?t) (at ?r ?w) (visible_from ?t ?w)
    )
...
(:action communicate_image_data
 ...
 :precondition (and(have_image ?r ?o ?m)(visible ?x ?y)(available ?r)(channel_free ?l)
            )
