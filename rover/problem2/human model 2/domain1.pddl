...
:effect (and (not (empty ?s)) (have_soil_analysis ?x ?p) (not (at_soil_sample ?p))
    )
)
...
:effect (and (not (empty ?s)) (full ?s)(not (at_rock_sample ?p))
    )
)
...
(:action communicate_rock_data
 ...
 :effect (and (not (available ?r))(channel_free ?l)(communicated_rock_data ?p)(available ?r)
          )
)
...
(:action communicate_image_data
 ...
 :effect (and (not (available ?r))(not (channel_free ?l))(communicated_image_data ?o ?m)(available ?r)
          )
)
